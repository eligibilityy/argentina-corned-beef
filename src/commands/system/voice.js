...
module.exports = {
    ...
    .addSubcommand(subcommand => 
        ...
        .addUserOption(option => 
            option.setName("member").setDescription("Select a member you want to add.").setRequired(true))
    )
    .addSubcommand(subcommand => 
        subcommand
        .setName("disallow")
        ...
        .addUserOption(option => 
            ...
            .setDescription("Member you want to revoke access to the channel.")
            .setRequired(true))
    )
    .addSubcommand(subcommand => 
        subcommand
    ...
    .addSubcommand(subcommand => 
        ...
        .addStringOption(option => 
            option.setName("turn")
            .setDescription("Enable or disable channel publicity.")
            .setRequired(true)
            .addChoices(
                {name: "on", value: "on"},
                {name: "off", value: "off"}
